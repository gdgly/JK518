...
/*根据液晶数据手册的参数配置*/
#define HBP  134//134		//HSYNC后的无效像素
#define VBP  11//11		//VSYNC后的无效行数

#define HSW   10//10		//HSYNC宽度
#define VSW   2//2//VSYNC宽度

#define HFP  16//16		//HSYNC前的无效像素
#define VFP   32//32		//VSYNC前的无效行数
...
#define BUFFER_OFFSET          ((uint32_t)640*480*3)    //sdram为16位的,液晶RGB888
...
#define LCD_COLOR_GREY           0x104E8B
#define LCD_COLOR_LIGHTGREY      0x175593
#define LCD_COLOR_BLUE           0x0000FF
#define LCD_COLOR_BLUE2          0x000090
#define LCD_COLOR_LIGHTBLUE      0x0033FF
...
#define LCD_COLOR_BACK           0x000088//0x0000FF//0x000990
#define LCD_COLOR_HLT            0x00F000
#define LCD_COLOR_OP             0x00F000
#define LCD_COLOR_BT          	 0x00F290
#define LCD_COLOR_GR1          	 0x00FFA0
#define LCD_COLOR_GR2          	 0x00AFF0
#define LCD_COLOR_GR3          	 0x1133F0
#define LCD_COLOR_GR4          	 0x22AF00
...
//#define LTDC_BL_GPIO_PORT         GPIOH
//#define LTDC_BL_GPIO_CLK          RCC_AHB1Periph_GPIOD
//#define LTDC_BL_GPIO_PIN          GPIO_Pin_12
//#define GENERAL_OCPWM_PINSOURCE	  GPIO_PinSource12
//#define GENERAL_OCPWM_AF		  GPIO_AF_TIM5

//#define LTDC_LR_GPIO_PORT        GPIOD
//#define LTDC_LR_GPIO_CLK         RCC_AHB1Periph_GPIOD
//#define LTDC_LR_GPIO_PIN         GPIO_Pin_11
//#define LTDC_LR_PINSOURCE        GPIO_PinSource11
//#define LTDC_LR_AF			     GPIO_AF_LTDC

//#define LTDC_UD_GPIO_PORT        GPIOD
//#define LTDC_UD_GPIO_CLK         RCC_AHB1Periph_GPIOD
//#define LTDC_UD_GPIO_PIN         GPIO_Pin_13
//#define LTDC_UD_PINSOURCE        GPIO_PinSource13
//#define LTDC_UD_AF			     GPIO_AF_LTDC
...
#define LTDC_BL_GPIO_PORT         GPIOH//D
#define LTDC_BL_GPIO_CLK          RCC_AHB1Periph_GPIOH//D
#define LTDC_BL_GPIO_PIN          GPIO_Pin_12//7
#define GENERAL_OCPWM_PINSOURCE	  GPIO_PinSource12
#define GENERAL_OCPWM_AF		  GPIO_AF_TIM5
...
#define LCD_FRAME_BUFFER       ((uint32_t)0xD0000000)
#define BUFFER_OFFSET          ((uint32_t)640*480*2)
