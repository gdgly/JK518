...
//  Red_Value >>= 2;//转RGB666
//  Green_Value >>= 2;//转RGB666
//  Blue_Value >>= 2;//转RGB666
...
void Drawfileusbmenu(void)
{
	...
	if(LANG == chs)
	{
		LCD_DisplayStringLine(450,35,"导入");

		LCD_DisplayStringLine(450,153,"覆盖");
		LCD_DisplayStringLine(450,293,"删除");
		LCD_DisplayStringLine(450,420,"显示");
		LCD_DisplayStringLine(450,548,"系统");

	}else{
		LCD_DisplayStringLine(450,30,"LOAD");

		LCD_DisplayStringLine(450,278,"OVER");
		LCD_DisplayStringLine(450,143,"DELETE");
...
//		LCD_DisplayStringLine(450,293,"系统");
		LCD_DisplayStringLine(450,153,"系统");
		LCD_DisplayStringLine(450,293,"短路");
		LCD_DisplayStringLine(450,420,"保持");
		if(KEYLOCK==0)
			LCD_DisplayStringLine(450,548,"锁键");
		else
			LCD_DisplayStringLine(450,548,"解键");
	}else{
		LCD_DisplayStringLine(450,10,"DISPLAY");
	//	LCD_DisplayStringLine(450,153,"GRAPH");
	//	LCD_DisplayStringLine(450,275,"SYSTEM");
		LCD_DisplayStringLine(450,285,"SHORT");
		LCD_DisplayStringLine(450,140,"SYSTEM");
		LCD_DisplayStringLine(450,410,"HOLD");
		if(KEYLOCK==0)
			LCD_DisplayStringLine(450,545,"LOCK");
		else
			LCD_DisplayStringLine(450,545,"OPEN");
	}
}
/*usb设置页面根菜单*/
void Drawusbmenu(void)
{
...
void Drawsetmenu(void)
{
	...
	{
		LCD_DisplayStringLine(450,35,"显示");
		LCD_DisplayStringLine(450,143,"设置显示");
		LCD_DisplayStringLine(450,270,"文件设置");
		LCD_DisplayStringLine(450,420,"比较器");
		LCD_DisplayStringLine(450,528,"系统信息");
	}else{
		LCD_DisplayStringLine(450,10,"DISPLAY");
		LCD_DisplayStringLine(450,140,"SET_DIS");
		LCD_DisplayStringLine(450,280,"FILE");
		LCD_DisplayStringLine(450,410,"COMP");
...
//		LCD_DisplayStringLine(450,153,"曲线图");
//		LCD_DisplayStringLine(450,293,"系统");
//		LCD_DisplayStringLine(450,420,"校准");
//		LCD_DisplayStringLine(450,528,"分选设置");
//	}else{
//		LCD_DisplayStringLine(450,10,"DISPLAY");
//		LCD_DisplayStringLine(450,153,"GRAPH");
//		LCD_DisplayStringLine(450,275,"SYSTEM");
...
void DrawLetmenu(u8 page)
{
	...
	if(LANG == chs)
	{
		if(page==1)
		{
		LCD_DisplayStringLine(450,528,"下一页");
		}
		else if(page==2)
		LCD_DisplayStringLine(450,528,"上一页");
		else 
			LCD_DisplayStringLine(450,528,"返回");
	}else{
		if(page==1)
		LCD_DisplayStringLine(450,520,"Next");
		else if(page==2)
		LCD_DisplayStringLine(450,520,"Last");
		else 
		LCD_DisplayStringLine(450,520,"Back");
	}
	if(page==1)
	{
		LCD_DisplayStringLine(450,35,"ADCD");
		LCD_DisplayStringLine(450,153,"EFGH");
		LCD_DisplayStringLine(450,290,"IJKL");
		LCD_DisplayStringLine(450,420,"MNOP");
	}
	else if(page==2)
	{
		LCD_DisplayStringLine(450,35,"QRST");
		LCD_DisplayStringLine(450,153,"UVWX");
		LCD_DisplayStringLine(450,300,"YZ");
	
	}
	else if(page==11)
	{
		LCD_DisplayStringLine(450,10,"A");
		LCD_DisplayStringLine(450,153,"B");
		LCD_DisplayStringLine(450,275,"C");
		LCD_DisplayStringLine(450,420,"D");
		
	
	}
	else if(page==12)
	{
		LCD_DisplayStringLine(450,10,"E");
		LCD_DisplayStringLine(450,153,"F");
		LCD_DisplayStringLine(450,275,"G");
		LCD_DisplayStringLine(450,420,"H");
	}
	else if(page==13)
	{
		LCD_DisplayStringLine(450,10,"I");
		LCD_DisplayStringLine(450,153,"J");
		LCD_DisplayStringLine(450,275,"K");
		LCD_DisplayStringLine(450,420,"L");
	}
	else if(page==14)
	{
		LCD_DisplayStringLine(450,10,"M");
		LCD_DisplayStringLine(450,153,"N");
		LCD_DisplayStringLine(450,275,"O");
		LCD_DisplayStringLine(450,420,"P");
	}
	else if(page==21)
	{
		LCD_DisplayStringLine(450,10,"Q");
		LCD_DisplayStringLine(450,153,"R");
		LCD_DisplayStringLine(450,275,"S");
		LCD_DisplayStringLine(450,420,"T");
		
	
	}
	else if(page==22)
	{
		LCD_DisplayStringLine(450,10,"U");
		LCD_DisplayStringLine(450,153,"V");
		LCD_DisplayStringLine(450,275,"W");
		LCD_DisplayStringLine(450,420,"X");
	}
	else if(page==23)
	{
		LCD_DisplayStringLine(450,10,"Y");
		LCD_DisplayStringLine(450,153,"Z");
	}
}
...
void Drawset_dismenu(void)
{
	...
	if(LANG == chs)
	{
		LCD_DisplayStringLine(450,35,"显示");
		LCD_DisplayStringLine(450,153,"系统");
		LCD_DisplayStringLine(450,270,"设置显示");
		LCD_DisplayStringLine(450,400,"温度校正");
		LCD_DisplayStringLine(450,530,"温度复位");
	}else{
		LCD_DisplayStringLine(450,10,"DISPLAY");
		LCD_DisplayStringLine(450,143,"SYSTEM");
		LCD_DisplayStringLine(450,268,"SET_DIS");
		LCD_DisplayStringLine(450,425,"CAL");
		LCD_DisplayStringLine(450,540,"RESET");
	}
}
/*曲线图页面根菜单*/
void Drawgraphmenu(void)
{
	...
	{
		LCD_DisplayStringLine(450,35,"显示");
		LCD_DisplayStringLine(450,153,"历史");
		LCD_DisplayStringLine(450,293,"系统");
		LCD_DisplayStringLine(450,420,"设置");
		LCD_DisplayStringLine(450,528,"曲线设置");
	}else{
		LCD_DisplayStringLine(450,10,"DISPLAY");
...
void Drawhishmenu(void)
{
	...
	if(LANG == chs)
	{
		...
		LCD_DisplayStringLine(450,293,"系统");
		LCD_DisplayStringLine(450,420,"设置");
		LCD_DisplayStringLine(450,528,"翻页");
	}else{
		LCD_DisplayStringLine(450,10,"DISPLAY");
...
void Drawsysinfomenu(void)
{
	...
	if(LANG == chs)
	{
		...
		LCD_DisplayStringLine(450,10,"DISPLAY");
		LCD_DisplayStringLine(450,153,"SYSTEM");
		LCD_DisplayStringLine(450,275,"FILE");
		LCD_DisplayStringLine(450,410,"COMP");
		LCD_DisplayStringLine(450,522,"SYSINFO");
	}
}
...
void Drawdate(void)
{
	...
	if(LANG == chs)
	{
		LCD_DisplayStringLine(450,35,"年+");
		LCD_DisplayStringLine(450,165,"年_");
		LCD_DisplayStringLine(450,293,"月+");
		LCD_DisplayStringLine(450,420,"月_");
		LCD_DisplayStringLine(450,548,"更多");
	}else{
...
void Drawdate2(void)
{
	...
	if(LANG == chs)
	{
		LCD_DisplayStringLine(450,35,"日+");
		LCD_DisplayStringLine(450,165,"日_");
		LCD_DisplayStringLine(450,548,"更多");
	}else{
...
void Drawtime(void)
{
	...
	if(LANG == chs)
	{
		LCD_DisplayStringLine(450,35,"时+");
		LCD_DisplayStringLine(450,165,"时_");
		LCD_DisplayStringLine(450,293,"分+");
		LCD_DisplayStringLine(450,420,"分_");
		LCD_DisplayStringLine(450,548,"更多");
	}else{
...
void Drawtime2(void)
{
	...
	if(LANG == chs)
	{
		LCD_DisplayStringLine(450,35,"秒+");
		LCD_DisplayStringLine(450,165,"秒_");
		LCD_DisplayStringLine(450,548,"更多");
	}else{
...
void DrawDim(void)
{
	if(LANG == chs)
	{
		LCD_SetTextColor(LCD_COLOR_YELLOW);
		LCD_SetBackColor(LCD_COLOR_BLACK);
		LCD_DisplayStringLine(450,35,"关闭");
...
{
  uint16_t i=0;
	FNT_GB24 *ptGb24 = (FNT_GB24 *)Chinese24x24_Table;		  /*ptGb16指向GBHZ_16*/
	while(ptGb24[i].Index[0] > 0x80)
	{
		if ((*hz == ptGb24[i].Index[0]) && (*(hz+1) == ptGb24[i].Index[1])) /*汉字用两位来表示地址码*/
		{
			LCD_DrawChinese(Line, Column, &ptGb24[i].Msk[0]);
		}
		i++;
		if(i > (sizeof((FNT_GB24 *)Chinese24x24_Table) / sizeof(FNT_GB24) - 1))  /* 搜索下标约束 */
			break;
	}
...
{
  uint16_t i=0;
	FNT_GB24x19 *ptGb24 = (FNT_GB24x19 *)Chinese24x19_Table;		  /*ptGb16指向GBHZ_16*/
	while(ptGb24[i].Index[0] > 0x80)
	{
		if ((*hz == ptGb24[i].Index[0]) && (*(hz+1) == ptGb24[i].Index[1])) /*汉字用两位来表示地址码*/
		{
		...
		i++;
		if(i > (sizeof((FNT_GB24x19 *)Chinese24x19_Table) / sizeof(FNT_GB24x19) - 1))  /* 搜索下标约束 */
			break;
	}
...
{
  uint16_t i=0;
	FNT_GB16x20 *ptGb24 = (FNT_GB16x20 *)Chinese16x20_Table;		  /*ptGb16指向GBHZ_16*/
	while(ptGb24[i].Index[0] > 0x80)
	{
		if ((*hz == ptGb24[i].Index[0]) && (*(hz+1) == ptGb24[i].Index[1])) /*汉字用两位来表示地址码*/
		{
		...
		i++;
		if(i > (sizeof((FNT_GB16x20 *)Chinese16x20_Table) / sizeof(FNT_GB16x20) - 1))  /* 搜索下标约束 */
			break;
	}
...
void LCD_DisplayStringLine_108(uint16_t x,uint16_t y, uint8_t *ptr)
{  
  uint16_t refcolumn = y;
  /* Send the string character by character on lCD */
  while ((refcolumn < LCD_PIXEL_WIDTH) && ((*ptr != 0) & (((refcolumn + LCD_Currentfonts->Width) & 0xFFFF) >= LCD_Currentfonts->Width)))
...
void LCD_DisplayStringLine_L(uint16_t x,uint16_t y, uint8_t *ptr)
{
  uint16_t refcolumn = y;
  /* Send the string character by character on lCD */
...
void LCD_Lstring_Ex(uint16_t Xpos, //字符显示位置x
										uint16_t Ypos, //字符显示位置y
										uint16_t Font_width, //字符宽度
										uint16_t Font_Heig,  //字符高度 
										uint8_t *ptr,						//
...
//			for(j=0;j<8;j++)
//			aaaa[i*8+j] = (ASCII64x128[i+((*ptr)*1024)]>>j)&1;
//		}
//		LCD_DrawChar_Ex(Ypos,Xpos+64*k++,Font_width,Font_Heig,(uint8_t*)&aaaa,DrawModel);
//	  *ptr++;
//	}
static uint8_t aaaa[7560]={0};	
//  static uint8_t aaaa[9216]={0};	
	uint8_t flag=0;
 k=0;
	while(*ptr!='\0')
	{
		...
		{
			for(j=0;j<8;j++)
			aaaa[i*8+j] = (ASCII64x128[i+((*ptr-0x2d)*1080)]>>j)&1;
		}

		if(flag==1)//-36
			LCD_DrawChar_Ex(Ypos,Xpos+72*k++,Font_width,Font_Heig,(uint8_t*)&aaaa,DrawModel);
	  else
			LCD_DrawChar_Ex(Ypos,Xpos+72*k++,Font_width,Font_Heig,(uint8_t*)&aaaa,DrawModel);
    if(*ptr=='.')
			flag=1;
