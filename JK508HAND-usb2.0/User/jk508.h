...
#define TC_PAR					 Correction[40] 
#define TC_TEP					 Correction[41] 
#define CONSTANT				 Correction[42] 

#define UPPER					 Correction[43] 
#define LOWER					 Correction[44] 
#define NOMA                      Correction[45] 

#define MODE					           Correction[46] 
#define RESISTIVITY					 				Correction[47] 
#define CONDUXTIVITY                Correction[48] 
#define RANGE               Correction[49] 
extern char rangename[10][10];
extern char rangenum[8][4];
//显示温度值
...
#define   NOM							  savedata[54]
#define   COMPMIN							  savedata[55]
#define   COMPMAX							  savedata[56]
#define   REL							  savedata[57]
#define   CALCULATION					savedata[58]

 
#define   TRIGGER							  savedata[59]
//#define   MODE							  savedata[60]
#define   KEYLOCK							  savedata[61]
#define   LOWERNOM							  savedata[63]
#define   UPPERNOM							  savedata[63]
...
#define set_rel         98
#define set_tc_par      99
#define set_tc_tep      100
#define set_delay       101
#define set_cal         102

#define set_cons        103


#define set_trigg        105
#define set_range        106
#define set_mode         107
#define set_min0		 108
#define set_let1		     109
#define set_let2		     110
#define set_let11		     111
#define set_let12		     112
#define set_let13		     113
#define set_let14		     114


#define set_let21		     115
#define set_let22		     116
#define set_let23		     117
#define set_let24		     118
#define set_lock            119
